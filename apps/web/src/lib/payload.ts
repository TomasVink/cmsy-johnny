...
export type IngredientsBlock = Extract<
  LayoutBlock,
  { blockType: "ingredients" }
>;
export type PhotoStripBlock = Extract<
  LayoutBlock,
  { blockType: "photo-strip" }
>;
export type StatementBannerBlock = Extract<
  LayoutBlock,
  { blockType: "statement-banner" }
>;
export type LocationsBlock = Extract<LayoutBlock, { blockType: "locations" }>;
export type FrituurbakkerSignupBlock = Extract<
  LayoutBlock,
  { blockType: "frituurbakker-signup" }
>;
export type SocialBlock = Extract<LayoutBlock, { blockType: "social" }>;
export type TickerBannerBlock = Extract<
  LayoutBlock,
