...
export const SignupBlock: Block = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: { description: 'Used as both label and placeholder for each field. Leave empty to use the default.' },
      fields: [
        { name: 'frituurName', type: 'text', localized: true, defaultValue: localeDefault('Naam frituur', 'Nom de la friterie') },
        { name: 'name', type: 'text', localized: true, defaultValue: localeDefault('Naam', 'Nom') },
        { name: 'address', type: 'text', localized: true, defaultValue: localeDefault('Adres', 'Adresse') },
        { name: 'postcode', type: 'text', localized: true, defaultValue: localeDefault('Postcode', 'Code postal') },
        { name: 'city', type: 'text', localized: true, defaultValue: localeDefault('Gemeente', 'Commune') },
        { name: 'phone', type: 'text', localized: true, defaultValue: localeDefault('Telefoonnummer', 'Numéro de téléphone') },
        { name: 'email', type: 'text', localized: true, defaultValue: localeDefault('E-mailadres', 'Adresse email') },
      ],
    },
  ],
}
